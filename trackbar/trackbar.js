...
// Methods
	...
	init : function(hash) {
		try {
			...
			this.jq.html('<div class="tickdiv" id="'+this.TICKDIV_PREFIX+this.id+'"></div><table id="'+this.TABLE_PREFIX+this.id+'" ' + (this.width ? ' style="width:'+this.width+'px;"' : '') + 'class="trackbar" onSelectStart="return false;">\
				<tr>\
					<td class="l"><div id="leftBlock"><span class="leftBlockValue"></span><span class="limit"></span><img id="leftBegun" ondragstart="return false;" src="/js/jquery/plugins/trackbar/imgtrackbar/b_l.png" width="6" height="11" alt="" /></div></td>\
					<td class="c" id="centerBlock"></td>\
					<td class="r"><div id="rightBlock"><span class="rightBlockValue"></span><span class="limit"></span><img id="rightBegun" ondragstart="return false;" src="/js/jquery/plugins/trackbar/imgtrackbar/b_r.png" width="6" height="11" alt="" /></div></td>\
				</tr>\
			</table>');
			// Is all right?
			if (this.onMove == null) {
	...
	setCurrentState : function() {
		...
		if(!this.clearValues){
			var leftValue = (!this.dual && this.leftWidth > this.width / 2) ? "" : this.leftValue;
			this.leftBlock.firstChild.innerHTML = leftValue;
			$('#'+this.ot_id+'__'+this.attr_id+'__leftValue').text(leftValue);
		}
		...
		if (!this.clearValues){
			var rightValue = (!this.dual && this.rightWidth >= this.width / 2) ? "" : this.rightValue;
			this.rightBlock.firstChild.innerHTML = rightValue;
			$('#'+this.ot_id+'__'+this.attr_id+'__rightValue').text(rightValue); 
		}
		if(!this.dual) {
