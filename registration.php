...
<span id="gen-pass">Сгенерировать</span>
</li>
...
<select id="sex" name="sex">
    <option id="sex-m">Мужской</option>
    <option id="sex-f">Женский</option>
</select>
</li>
...
<p align="right" ><input type="submit" name="reg-submint" id="form_submit" value="Регистрация" /></p>
